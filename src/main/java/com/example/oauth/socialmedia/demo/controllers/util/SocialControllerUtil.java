package com.example.oauth.socialmedia.demo.controllers.util;
...
public class SocialControllerUtil
{
    ...
    {
        UserConnection connection = (UserConnection) session
                .getAttribute(USER_CONNECTION);
    ...
    protected String getDisplayName(UserConnection connection, UserProfile profile)
    {
        ...
        // The name is set differently in different providers so we better look in both
        // places...
